...
public class UserDataBaseProvider extends ContentProvider {
	...
	private static final String DB_CREATE = "create table " + USER_TABLE + "("
	+ USER_ID + " integer primary key autoincrement, "
	+ USER_NAME + " text, " + USER_WEIGHT + " integer" + ");";
	...
	private static final String USER_CONTENT_TYPE = "vnd.android.cursor.dir/vnd." + AUTHORYTY + "." + USER_PATH;
	private static final String USER_CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd." + AUTHORYTY + "." + USER_PATH;
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		case URI_USERS_ID:
			...
			break;
		default:
			throw new IllegalArgumentException("Wrong uri :: query URI == " + uri + "  match uri == " + uriMatcher.match(uri));
		}
		db = dbHelper.getWritableDatabase();
